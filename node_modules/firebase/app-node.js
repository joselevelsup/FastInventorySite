...
z.prototype.subscribe=function(a,b,c){var d=this,e;if(void 0===a&&void 0===b&&void 0===c)throw Error("Missing Observer.");e=y(a)?a:{next:a,error:b,complete:c};void 0===e.next&&(e.next=x);void 0===e.error&&(e.error=x);void 0===e.complete&&(e.complete=x);a=this.B.bind(this,this.a.length);this.c&&this.task.then(function(){try{d.h?e.error(d.h):e.complete()}catch(a){}});this.a.push(e);return a};
z.prototype.B=function(a){void 0!==this.a&&void 0!==this.a[a]&&(this.a[a]=void 0,--this.l,0===this.l&&void 0!==this.g&&this.g(this))};var B=function(a,b){if(!a.c)for(var c=0;c<a.a.length;c++)C(a,c,b)},C=function(a,b,c){a.task.then(function(){if(void 0!==a.a&&void 0!==a.a[b])try{c(a.a[b])}catch(d){}})};z.prototype.close=function(a){var b=this;this.c||(this.c=!0,void 0!==a&&(this.h=a),this.task.then(function(){b.a=void 0;b.g=void 0}))};var D=function(a,b){b=b||{};var c={noApp:"No Firebase App '"+b.name+"' has been created - call Firebase App.initializeApp().","bad-app-name":"Illegal App name: '"+b.name+"'.",dupApp:"Firebase App named '"+b.name+"' already exists.",deleted:"Firebase App named '"+b.name+"' already deleted.",dupService:"Firebase Service named '"+b.name+"' already registered."}[a];return void 0===c?"Application Error: ("+a+")":c},E=function(a,b){throw Error(D(a,b));},G=function(){function a(a){a=a||"[DEFAULT]";var c=
b[a];void 0===c&&E("noApp",{name:a});return c}var b={},c={},d=[],e={initializeApp:function(a,c){void 0===c?c="[DEFAULT]":"string"===typeof c&&""!==c||E("bad-app-name",{name:c+""});void 0!==b[c]&&E("dupApp",{name:c});var f=new F(a,c,e);b[c]=f;d.forEach(function(a){return a("create",f)});void 0!=f.INTERNAL&&void 0!=f.INTERNAL.getToken||r(f,{INTERNAL:{getToken:function(){return w.resolve(null)},addAuthTokenListener:function(){},removeAuthTokenListener:function(){}}});return f},app:a,apps:null,Promise:w,
SDK_VERSION:"0.0.0",INTERNAL:{registerService:function(b,d,f){c[b]&&E("dupService",{name:b});c[b]=d;d=function(c){void 0===c&&(c=a());return c[b]()};void 0!==f&&r(d,f);return e[b]=d},createFirebaseNamespace:G,extendNamespace:function(a){r(e,a)},createSubscribe:A,ErrorFactory:t,registerAppHook:function(a){d.push(a)},removeApp:function(a){d.forEach(function(c){return c("delete",b[a])});delete b[a]},factories:c,Promise:void 0,deepExtend:r}};Object.defineProperty(e,"apps",{get:function(){return Object.keys(b).map(function(a){return b[a]})}});
a.App=F;return e},F=function(a,b,c){var d=this;this.i=c;this.j=!1;this.b={};this.s={};this.f=b;this.v=r(void 0,a);Object.keys(c.INTERNAL.factories).forEach(function(a){d[a]=d.u.bind(d,a)})};F.prototype.delete=function(){var a=this;return(new w(function(b){H(a);b()})).then(function(){a.i.INTERNAL.removeApp(a.f);return w.all(Object.keys(a.b).map(function(b){return a.b[b].INTERNAL.delete()}))}).then(function(){a.j=!0;a.b=null;a.s=null})};
